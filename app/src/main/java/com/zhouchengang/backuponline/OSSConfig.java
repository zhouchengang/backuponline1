...
public class OSSConfig {
    ...
    public static final String BUCKET_NAME = "backupzcg";
    public static final String OSS_ACCESS_KEY_ID = "LTAI4GEBqghJsjehciQKfSzu";;
    public static final String OSS_ACCESS_KEY_SECRET = "KoP7tPbfjNYZ2cjNaIOiyx3f1tsUhA";
